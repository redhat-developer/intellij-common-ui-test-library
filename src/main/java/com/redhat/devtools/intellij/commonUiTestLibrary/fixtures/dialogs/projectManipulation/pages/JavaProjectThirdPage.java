...
public class JavaProjectThirdPage extends AbstractTerminalPage {
     ...
     * @throws RuntimeException when there is set another value than defined by the 'ProjectFormatType' enumeration in the combo box
     */
    public ProjectFormatType getProjectFormat() {
        ...
        if (projectFormatComboBox.selectedText().contains(ProjectFormatType.IDEA_DIRECTORY_BASED.toString())) {
            ...
            throw new RuntimeException("Currently selected project format is not supported.");
        }
    }
