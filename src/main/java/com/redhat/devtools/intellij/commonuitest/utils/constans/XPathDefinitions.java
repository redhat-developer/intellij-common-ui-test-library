...
public class XPathDefinitions {
    ...
    public static final String TIP_DIALOGA_2 = "//div[@text='Tip of the Day']";
    ...
    public static final String PROJECT_SDK_COMBOBOX = "//div[@accessiblename='Project SDK:' and @class='JPanel']/div[@class='JdkComboBox']";
    ...
    public static final String PROJECT_SDK = "//div[@text='Project SDK:']";
